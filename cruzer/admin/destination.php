	  ...
	  <div class="row">
        ...
        <div class="header">							
          ...
          <div class="form-group col-md-3 setmyheight">
              ...
              <label>Destination Name</label> <input type="text" name="add_des" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
          <div class="form-group col-md-3 ">
              <label>Latitude</label> <input type="text" name="lat" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
          <div class="form-group col-md-3 ">
              <label>Longitude</label> <input type="text" name="lon" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
          <div class="clear"></div>
          <div class="form-group col-md-4 ">
              <label>Country Description</label><textarea name="des_des" rows="5" cols="50"></textarea>
          </div>
          <div class="clear"></div>
          <div class="form-group col-md-3 ">
          <label>Upload an image</label><input type="file"  name="img_path" />

          </div>    
          <div class="form-group col-md-3 ">
          <label>Upload Country Flag</label><input type="file"  name="logo" />
            ...
            <div class="clear"></div>
              ...
              <div class="col-lg-12">  
              <div class="checkbox"><label> <input name="to_scroll" value="1" type="checkbox"> Add this destination to scroller </label> </div>              
