	  ...
	  <div class="row">
        ...
        <div class="header">							
          ...
          <div class="content">
            ...
            <form action="" enctype="multipart/form-data" id="myform" method="post" parsley-validate novalidate> 
          
          <div class="form-group col-md-3">
          
          
              <label>Airline Name</label> <input type="text" name="name" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
          <div class="form-group col-md-3 ">
              <label>Allowed Baggage (KG)</label> <input type="text" name="kg" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
          <div class="form-group col-md-3 ">
              <label>Max Baggade Allowed</label> <input type="text" name="max" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
           <div class="form-group col-md-3 ">
              <label>Baggage Size (cm<sup>2</sup>)</label> <input type="text" name="size" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
           
           <div class="form-group col-md-3 ">
              <label>Max Hand Baggage Allowed</label> <input type="text" name="max_hand" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
           <div class="form-group col-md-3 ">
              <label>Hand Baggage size (cm<sup>2</sup>)</label> <input type="text" name="hand_size" parsley-trigger="change"   placeholder="" class="form-control">
          </div>
          <div class="clear"></div>

          <div class="form-group col-md-3 ">
              <label>Upload Airline Logo</label><input name="logo" parsley-trigger="change" class="form-control" type="file">
          </div>          
