	  ...
	  <div class="row">
        ...
        <div class="header">							
          ...
          <div class="form-group col-md-3 setmyheight">
              ...
              <label>Username</label> <input type="text" name="name" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
          <div class="form-group col-md-3 setmyheight">

              <label>Password</label> <input type="text" name="password" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
